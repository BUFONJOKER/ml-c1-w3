...
class plt_one_addpt_onclick:
    """Class to run one interactive plot for linear/logistic regression."""
    ...
    def __init__(self, x, y, w, b, logistic=True):
        ...
        ax.set_title(
            "Logistic Regression Example" if logistic else "Linear Regression Example")
    ...
    def draw_thresh(self):
        ...
        c = self.ax[0].annotate("Malignant", xy=[xp5, 0.5], xycoords='data', xytext=[
                                30, 5], textcoords='offset points')
        d = FancyArrowPatch(posA=(xp5, 0.5), posB=(xp5+1.5, 0.5), color=dldarkred,
                            arrowstyle='simple, head_width=5, head_length=10, tail_width=0.0')
        self.ax[0].add_artist(d)
        e = self.ax[0].annotate("Benign", xy=[
                                xp5, 0.5], xycoords='data', xytext=[-70, 5], textcoords='offset points', ha='left')
        f = FancyArrowPatch(posA=(xp5, 0.5), posB=(xp5-1.5, 0.5), color=dlblue,
                            arrowstyle='simple, head_width=5, head_length=10, tail_width=0.0')
